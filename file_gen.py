"""Created by Oleg Osadchuk for tests in Python Core course"""
import shutil
...
def get_random_filename():
    ...
    return ''.join(choices(random_value, k=5))


def generate_text_files(path):
    documents = ('doc', 'docx', 'txt', 'pdf', 'xlsx', 'jpeg', 'png')
...
if __name__ == '__main__':
    parent_folder_path = Path("test_folder")
